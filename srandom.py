...
class Random:
    ...
    def __init__(self, seed=None):
        ...
        if seed is None:
            ...
            seed = id(object()) + id(Random._seed_counter) + Random._seed_counter
        
        self.a, self.b, self.c, self.d, self.e, self.f, self.g, self.h, self.i = self.hash(seed)
        self.i = self.i / 1000        
        for i in range(20):
            self.next()
    ...
    def uuid(self):
        ...
        parts = [
            ...
            self.choice(('8', '9', 'a', 'b')) + ''.join(strings[self.randint(0, length)] for _ in range(3)),
